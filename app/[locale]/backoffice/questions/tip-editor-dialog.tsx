...
// import { Check, ChevronDown, ChevronUp, FileUp, ImageIcon, Lightbulb, Loader2, Trash2, Upload } from 'lucide-react';
// import { useAuthStore } from '@/lib/store';
// import type { QuestionAsset } from '@/lib/types/admin';
...
// export interface TipAssetDraft {
//   file: File;
//   type: AssetType;
//   alt: string;
//   caption: string;
...
// interface TipEditorDialogProps {
//   open: boolean;
//   mode: 'create' | 'edit';
//   formData: Record<string, string>;
//   displayOrder: number;
//   locale: string;
//   assets: TipAssetDraft[];
//   existingAssets: QuestionAsset[];
//   isLoading?: boolean;
...
//   onAssetsChange: (assets: TipAssetDraft[]) => void;
//   onDeleteExistingAsset: (assetUrl: string) => void;
//   onSave: () => void;
// }
...
// export function TipEditorDialog({
//   open,
//   mode,
//   formData,
//   displayOrder,
...
//   onLocaleChange,
//   onAssetsChange,
//   onDeleteExistingAsset,
//   onSave,
// }: TipEditorDialogProps) {
...
//         <div key={`tip-${locale}`} dir={languages.find(l => l.code === locale)?.direction || 'ltr'}>
//           {/* ── Header ── */}
//           <DialogHeader>
...
//             {/* Tip text */}
//             <SectionBlock title="Tip Text" icon={Lightbulb}
//               action={
...
//               }>
//               <QuillEditor
//                 key={`tip-editor-${locale}`}
//                 value={formData[locale] || ''}
//                 onChange={(value) =>
//                   onFormDataChange({ ...formData, [locale]: value })
//                 }
//                 placeholder={`Enter tip text in ${languages.find(l => l.code === locale)?.label ?? locale}…`}
//                 className="min-h-[150px]"
//                 dir={languages.find(l => l.code === locale)?.direction || 'ltr'}
//               />
//               <p className="mt-2 text-[11px] text-white/25 font-light">
...
//                   <h4 className="text-[10px] uppercase tracking-widest text-white/35 font-medium">Display Order</h4>
//                 </div>
...
//                     min={0}
//                     value={displayOrder}
//                     onChange={e => onDisplayOrderChange(parseInt(e.target.value, 10) || 0)}
//                     placeholder="e.g. 1, 2, 3…"
//                     className={inputClass}
//                   />
//                   <p className="mt-2 text-[11px] text-white/25 font-light">
//                     Lower numbers appear first. Tips with the same order are sorted by creation date.
//                   </p>
//                 </div>
//               </div>
//             )}

//             {/* Existing assets (edit mode only) */}
//             {isAdmin && existingAssets.length > 0 && (
//               <SectionBlock title="Current Assets" icon={ImageIcon}>
...
//                           <a href={url} target="_blank" rel="noreferrer" className="truncate text-[11px] text-white/30 underline">
//                             {asset.filename || asset.url}
//                           </a>
//                           <button type="button" onClick={() => onDeleteExistingAsset(asset.url)}
...
//             {isAdmin && (
//               <SectionBlock title="Upload Assets" icon={ImageIcon}
//                 action={
...
//               {mode === 'create' ? 'Add Tip' : 'Save Changes'}
//             </button>
//           </DialogFooter>
//         </div>
//       </DialogContent>
